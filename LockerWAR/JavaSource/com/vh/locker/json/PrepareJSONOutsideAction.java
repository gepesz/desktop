 ...
 * 
 */
public class PrepareJSONOutsideAction extends BaseOutsideAction {

  private static Logger log = Logger.getLogger(PrepareJSONOutsideAction.class);
  ...
  public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if(json_bridge == null) {
	  ...
	  json_bridge.registerObject("outsideService", new JSONOutsideServiceImpl(session));
