 ...
 * @version 1.0
 * 
 * Plays mp3 mixes that user selects.
 */
 ...
 * 
 */
public class PlayMix extends BaseInsideAction {

  private static Logger log = Logger.getLogger(PlayMix.class);
  ...
  public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    String[] mixIds = gridForm.getId(); // the selected albums ids
    ...
    for(int i=0;i<mixIds.length;i++) {
      Collection mp3Coll = mcs.findMusicFileByMix(new Long(mixIds[i]));
      if(mp3Coll!=null) {
