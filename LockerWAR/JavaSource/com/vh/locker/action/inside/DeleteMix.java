 ...
 * @version 1.0
 * 
 * Deletes mp3 mixes that user selects.
 */
 ...
 * 
 */
public class DeleteMix extends BaseInsideAction {

  private static Logger log = Logger.getLogger(DeleteMix.class);
  ...
  public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    mcs.deleteMixes(id, ActionUtils.getUserId(request));
