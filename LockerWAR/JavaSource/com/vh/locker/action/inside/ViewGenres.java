 ...
 * 
 */
public class ViewGenres extends BaseInsideAction {

	private static Logger log = Logger.getLogger(ViewGenres.class);
    ...
    Collection genreColl = mcs.findGenreByUser(ActionUtils.getUserId(request));
    releaseService(Constants.SERVICEKEY_MUSIC, mcs);
    request.setAttribute("genreColl", genreColl);
