 ...
 * 
 */
public class ViewMixes extends BaseInsideAction {

	private static Logger log = Logger.getLogger(ViewMixes.class);
    ...
    Collection mixColl = mcs.findMixesByUser(ActionUtils.getUserId(request));
    releaseService(Constants.SERVICEKEY_MUSIC, mcs);
    request.setAttribute("mixColl", mixColl);
