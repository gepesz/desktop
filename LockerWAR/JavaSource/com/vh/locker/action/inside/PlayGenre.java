 ...
 * @version 1.0
 * 
 * Plays mp3 genres that user selects.
 */
 ...
 * 
 */
public class PlayGenre extends BaseInsideAction {

  private static Logger log = Logger.getLogger(PlayGenre.class);
  ...
  public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    String[] genreIds = gridForm.getId(); // the selected albums ids
    ...
    for(int i=0;i<genreIds.length;i++) {
      Collection mp3Coll = mcs.findMusicFileByGenre(new Long(genreIds[i]));
      if(mp3Coll!=null) {
