 ...
 * 
 */
public class ViewAlbums extends BaseInsideAction {

	private static Logger log = Logger.getLogger(ViewAlbums.class);
    ...
    Collection albumColl = mcs.findAlbumByUser(ActionUtils.getUserId(request));
    releaseService(Constants.SERVICEKEY_MUSIC, mcs);
    request.setAttribute("albumColl", albumColl);
