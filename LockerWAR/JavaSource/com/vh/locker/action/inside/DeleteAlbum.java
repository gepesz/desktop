 ...
 * @version 1.0
 * 
 * Deletes mp3 albums that user selects.
 */
 ...
 * 
 */
public class DeleteAlbum extends BaseInsideAction {

  private static Logger log = Logger.getLogger(DeleteAlbum.class);
  ...
  public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    mcs.deleteAlbums(id, ActionUtils.getUserId(request));
