 ...
 * @version 1.0
 * 
 * Plays mp3s of the specified artists.
 */
 ...
 * 
 */
public class PlayArtist extends BaseInsideAction {

  private static Logger log = Logger.getLogger(PlayArtist.class);
  ...
  public ActionForward executeAction(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    String[] artistIds = gridForm.getId(); // the selected artists' ids
    ...
    for(int i=0;i<artistIds.length;i++) {
      Collection mp3Coll = mcs.findMusicFileByArtist(new Long(artistIds[i]));
      if(mp3Coll!=null) {
