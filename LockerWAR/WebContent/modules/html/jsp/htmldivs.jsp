...
<div class="zuiDropDown" id="htmlFileMenu">
    <ul>
        <li onmouseover="this.className='hover';" onmouseout="this.className='';" onclick="MENU.hide();"><img alt="Add" width="16" height="16" border="0" src="<c:url value='/modules/html/img/addhtml.gif'/>" />&nbsp;Add</li>
  ...
  <div class="zuiDropDown" id="htmlHelpMenu">
    <ul>
