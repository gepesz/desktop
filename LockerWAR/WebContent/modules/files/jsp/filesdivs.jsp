...
<div class="zuiDropDown" id="filesFileMenu">
    <ul>
        <li onmouseover="this.className='hover';" onmouseout="this.className='';" onclick="MENU.hide();"><img alt="New File" width="16" height="16" border="0" src="<c:url value='/modules/files/img/appointment.gif'/>" />&nbsp;New File</li>
        <li onmouseover="this.className='hover';" onmouseout="this.className='';" onclick="MENU.hide();"><img alt="New Folder" width="16" height="16" border="0" src="<c:url value='/modules/files/img/foldernew.gif'/>" />&nbsp;New Folder</li>
		...
		<li onmouseover="this.className='hover';" onmouseout="this.className='';" onclick="MENU.hide();"><img alt="Edit" width="16" height="16" border="0" src="<c:url value='/common/img/edit.gif'/>" />&nbsp;Edit</td></li>
  ...
  <div class="zuiDropDown" id="filesHelpMenu">
    <ul>
